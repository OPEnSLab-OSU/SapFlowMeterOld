...
// ===                       DEFINITIONS                        === 
// ================================================================
#define DATAPIN A4         // change to the proper pin
//#define DATAPIN 11
...
//    Serial.println("mySDI12 is available");
	}
//	if (sdiResponse.length() > 1) 
//	{
//    char tmp[20];
//    sdiResponse.toCharArray(tmp, 20);
//	  LOOM_DEBUG_Println2("sdiResponse: ", tmp); //write the response to the screen
//	}
	mySDI12.clearBuffer();
...
//    Serial.println("mySDI12 is still available");

	}
	
	sdiResponse.toCharArray(buf, sizeof(buf));

  LOOM_DEBUG_Println2("buf: ", buf);
